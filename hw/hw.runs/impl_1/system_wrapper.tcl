...
namespace eval ::optrace {
  variable script "E:/GitHub/zybo-z7-10-Audio-Project/hw/hw.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/GitHub/zybo-z7-10-Audio-Project/hw/hw.runs/synth_1/system_wrapper.dcp
